      ...
      <main className="flex-1">
        ...
        <section className="bg-celis-gradient-hero relative overflow-hidden border-b border-celis-border px-4 py-24 sm:py-32">
          ...
          <motion.div
            ...
            className="pointer-events-none absolute -left-24 -top-24 h-[28rem] w-[28rem] rounded-full bg-celis-primary blur-3xl"
          />
          <motion.div
            animate={{ scale: [1, 1.05, 1], opacity: [0.03, 0.06, 0.03] }}
            transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
            className="pointer-events-none absolute -bottom-32 -right-32 h-[28rem] w-[28rem] rounded-full bg-celis-secondary blur-3xl"
          />
          ...
          <div className="grid auto-rows-[minmax(180px,auto)] grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <Card className="group relative h-full overflow-hidden border-celis-border bg-gradient-to-br from-celis-primary/10 to-celis-secondary/5 transition hover:-translate-y-1 hover:shadow-md">
                <CardContent className="flex h-full flex-col justify-between p-6">
                  <div className="flex items-start justify-between">
                    <div className="rounded-xl bg-celis-bg p-3 shadow-sm">
            ...
            <FadeIn delay={0.1}>
              <Card className="group h-full border-celis-border bg-celis-bg transition hover:-translate-y-1 hover:shadow-sm">
                <CardContent className="flex h-full flex-col justify-between p-6">
                  <div className="rounded-xl bg-celis-primary-subtle p-3">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid auto-rows-[minmax(140px,auto)] grid-cols-1 gap-4 md:grid-cols-4">
              ...
              <FadeIn delay={0.05} className="md:col-span-2">
                <Card className="group h-full border-celis-border bg-celis-bg transition hover:-translate-y-1 hover:shadow-sm">
                  <CardContent className="flex h-full items-center gap-5 p-6">
                    <div className="rounded-xl bg-celis-secondary-subtle p-3">
                      <Smartphone className="h-7 w-7 text-celis-secondary" />
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-celis-ink">
              ...
              <FadeIn delay={0.1}>
                <Card className="group h-full border-celis-border bg-celis-bg transition hover:-translate-y-1 hover:shadow-sm">
                  <CardContent className="flex h-full flex-col justify-between p-5">
                    <div className="rounded-xl bg-celis-primary-subtle p-2.5">
              ...
              <FadeIn delay={0.15}>
                <Card className="group h-full border-celis-border bg-celis-bg transition hover:-translate-y-1 hover:shadow-sm">
                  <CardContent className="flex h-full flex-col justify-between p-5">
                    <div className="rounded-xl bg-celis-secondary-subtle p-2.5">
        ...
        <section className="mx-auto max-w-7xl px-4 py-24">
          <FadeIn>
            <div className="relative overflow-hidden rounded-2xl bg-celis-primary px-6 py-16 text-center text-white">
              <motion.div
                animate={{ rotate: 360 }}
                transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
                className="pointer-events-none absolute -right-24 -top-24 h-64 w-64 rounded-full border-[40px] border-white/10"
              />
              <motion.div
                animate={{ rotate: -360 }}
                transition={{ duration: 80, repeat: Infinity, ease: "linear" }}
                className="pointer-events-none absolute -bottom-24 -left-24 h-64 w-64 rounded-full border-[40px] border-white/10"
              />
